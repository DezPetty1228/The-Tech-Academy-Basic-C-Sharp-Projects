...
namespace Twentyone // methods must be inside the namespace
{
    class Program // basic models of objects are Classes 
    {
        ...
        static void Main(string[] args) // function or method or routine = Main
        {
            ...
            game.Players = new List<string>() { "mike", "Thomas", "Kaleb", };
            game.ListPlayers();
            // game.Play();
            Console.ReadLine();
            ...
            //     Deck deck = new Deck();                     //deck = shuffle(deck); // shuffles deck and then returns it as Deck //deck is a -      // instantiation of an object assigned to variable  "deck" using data type and class "Deck" model
            //     int timesShuffled = 0;
